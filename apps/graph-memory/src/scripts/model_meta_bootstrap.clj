(ns scripts.model-meta-bootstrap
  "Insert or update the meta-model descriptor in the graph store."
  (:require [app.model-meta :as model]
            [app.store-manager :as store-manager]))

(defn- usage []
  (str "Usage: clojure -M -m scripts.model-meta-bootstrap [--force]\n"))
  ...
  (let [opts (parse-args args)]
    ...
    (let [profile (store-manager/default-profile)
      ...
      (try
        ...
        (println "Meta-model descriptor ready.")
        (finally
