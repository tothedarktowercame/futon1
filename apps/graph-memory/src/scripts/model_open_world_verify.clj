(ns scripts.model-open-world-verify
  "Run open-world ingest model invariants and print results."
  (:require [app.model-open-world :as model]
            [app.store-manager :as store-manager]
            [clojure.pprint :as pprint]))

(defn- usage []
  (str "Usage: clojure -M -m scripts.model-open-world-verify [--out PATH]\n"
