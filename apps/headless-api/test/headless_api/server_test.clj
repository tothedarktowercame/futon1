(ns headless-api.server-test
  (:require [cheshire.core :as json]
            [clojure.string :as str]
            [clojure.test :refer [deftest is testing]]
            [headless_api.server :as server]
...
(defn- temp-dir []
  (.toAbsolutePath (Files/createTempDirectory "headless-api-test" (make-array java.nio.file.attribute.FileAttribute 0))))
